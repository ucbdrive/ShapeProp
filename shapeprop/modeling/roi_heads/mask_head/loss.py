...
class MaskRCNNLossComputation(object):
    ...
    def __call__(self, proposals, mask_logits, targets):
        ...
        if mask_targets.numel() == 0:
            ...
            if self.cfg.MODEL.ROI_MASK_HEAD.CLASS_AGNOSTIC:
                mask_logits = mask_logits[positive_inds].squeeze(1)
            else:
                labels = labels[positive_inds]
                mask_logits = mask_logits[positive_inds, labels]
