...
from shapeprop.utils.miscellaneous import mkdir
...
def main():
    ...
    ckpt = cfg.MODEL.WEIGHT if args.ckpt == 'latest' else args.ckpt
    _ = checkpointer.load(ckpt, use_latest=args.ckpt == 'latest')
    ...
    if cfg.OUTPUT_DIR:
        ...
        for idx, dataset_name in enumerate(dataset_names):
            output_folder = os.path.join(cfg.OUTPUT_DIR, "inference", ckpt, dataset_name)
            mkdir(output_folder)
